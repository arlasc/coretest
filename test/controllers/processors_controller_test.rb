...
class ProcessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create processor" do
    assert_difference("Processor.count") do
      post processors_url, params: { processor: { brand: @processor.brand, product_name: @processor.product_name } }
    end
  ...
  test "should update processor" do
    patch processor_url(@processor), params: { processor: { brand: @processor.brand, product_name: @processor.product_name } }
